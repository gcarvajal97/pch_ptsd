        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView>
                    ...
                    <Text style={styles.headline}>{translate('dealWithWorries.q1')}</Text>
                    <Text style={styles.paragraph}>{translate('dealWithWorries.q1_p1')}</Text>
                    <Text style={styles.paragraph}>{translate('dealWithWorries.q1_p2')}</Text>

                    <Text style={styles.headline}>{translate('dealWithWorries.q2')}</Text>
                    <Text style={styles.paragraph}>{translate('dealWithWorries.q2_p1')}</Text>
                    <Text style={styles.paragraph}>{translate('dealWithWorries.q2_p2')}</Text>
                    <Text style={styles.paragraph}>{translate('dealWithWorries.q2_p3')}</Text>
                    ...
                    <Text style={styles.paragraphBold}>{translate('dealWithWorries.q4_tip2')}</Text>
                    <Text style={styles.bulletLight}>{translate('dealWithWorries.q4_tip2_bullet')}</Text>
                    <Text style={styles.paragraphBold}>{translate('dealWithWorries.q4_tip3')}</Text>
                    <Text style={styles.bulletLight}>{translate('dealWithWorries.q4_tip3_bullet')}</Text>
                    <Text style={styles.paragraphBold}>{translate('dealWithWorries.q4_tip4')}</Text>
                    <Text style={styles.bulletLight}>{translate('dealWithWorries.q4_tip4_bullet')}</Text>
