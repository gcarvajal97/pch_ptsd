...
const PAGES = [
  { name: 'In the Emergency Department', content: <IntheED />, value: 0, accessibilityHint: '...' },
  { name: 'In the Hospital', content: <InTheHospital/>, value: 1, accessibilityHint: '...' },
  { name: 'After the Hospital', content: <AfterTheHospital/>, value: 2, accessibilityHint: '...' },
]
