...
export default class QuizResults extends Component {
    ...
    render() {
        ...
        const results = this.props.navigation.getParam(
            "results",
            "nothing found"
        );
        var count = 0;
        ...
        if (count === 0) {
            return (
                <View style={styles.blankContainer}>
                    <Text style={styles.noResponse} accessible>
                        {" "}
                        {translate("quizResults.noAnswers")}{" "}
                    </Text>
                </View>
            );
        } else {
                                ...
                                return (
                                    ...
                                    >
                                        <Text style={styles.paragraphBold}>
                                            {" "}
                                            {translate(
                                                "quizResults.whyHappens"
                                            )}{" "}
                                        </Text>
                                        <Text style={styles.paragraph}>
                                            {" "}
                                            {translate(
                                                "quizResults.q" + key + "body1"
                                            )}{" "}
                                        </Text>
                                        <Text style={styles.paragraphBold}>
                                            {" "}
                                            {translate(
                                                "quizResults.isProblem"
                                            )}{" "}
                                        </Text>
                                        <Text style={styles.paragraph}>
                                            {" "}
                                            {translate(
                                                "quizResults.q" + key + "body2"
                                            )}{" "}
                                        </Text>
                                    </Card>
                                );
